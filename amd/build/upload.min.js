    ...
    root.on(_modal_events.default.shown, async () => {
      ...
      if (input) {
        input.addEventListener('change', async () => {
          ...
          if (pendingResume && selectedFile && selectedFile.name === pendingResume.filename && selectedFile.size === pendingResume.size && (await fingerprintFile(selectedFile)) === pendingResume.fingerprint) {
            resumeActive = true;
